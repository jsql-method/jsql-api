...
public class AppDevAppsControllerTest extends IntegrationTest {
...
//        DeveloperAssignRequest memberAssignRequest = new DeveloperAssignRequest(appDev.id, exampleApp.id)
